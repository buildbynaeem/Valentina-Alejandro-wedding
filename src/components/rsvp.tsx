...
import { Cake, Cookie, Check } from "lucide-react";
            ...
            {sent ? (
              ...
              <div className="space-y-10">
                ...
                <Field label={t.rsvp.diet}>
                  <input type="text" placeholder={t.rsvp.dietPlaceholder} className={inputCls} />
                </Field>
                ...
                <div className="pt-4 flex flex-col items-center gap-4">
                  <button
                    type="submit"
                    className="group inline-flex items-center gap-3 bg-ink text-cream px-10 py-4 text-[11px] tracked hover:bg-gold hover:text-ink transition-colors duration-500"
                  >
                    {t.rsvp.submit}
                  </button>
